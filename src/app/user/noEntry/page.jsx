...
import { AlertCircle, Calendar, Hotel, ChevronDown, ChevronUp ,PlusCircleIcon} from "lucide-react";
                      ...
                      <div className="pt-4">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                          {hotel.missing_sales_dates.map((date, i) => (
                            <div
                              key={i}
                              className="flex justify-between  items-centermgap-3 p-3 bg-white border border-gray-100 rounded-lg"
                            >
                              ...
                              <button onClick={() => addSales(date)} className="px-2 py-2  text-green-700 rounded-lg text-sm font-medium active:bg-green-100">
                             <PlusCircleIcon />
                            </button>
                            </div>
                          ))}
