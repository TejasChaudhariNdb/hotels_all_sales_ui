...
export default function NotificationPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-12 px-1 space-y-6">
      {/* -------------------- Push Status Card -------------------- */}
      {permission !== "granted" && (
        <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-2xl p-6 md:p-8 space-y-4 shadow-sm animate-in fade-in slide-in-from-top-2">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-amber-100/80 rounded-2xl shadow-inner">
              <BellRing className="text-amber-800" size={24} />
            </div>
            <div className="flex-1">
              <h2 className="text-lg md:text-xl font-bold text-amber-900">Enable Push Notifications</h2>
              <p className="text-sm md:text-base text-amber-800/90 mt-1 leading-relaxed">
          ...
          <button
            ...
            className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3.5 px-4 md:py-4.5 rounded-2xl shadow-md transition-all active:scale-95 text-center text-sm md:text-base"
          >
      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-6 md:p-8 space-y-6">
        <div className="flex items-start gap-4">
          <div className="p-3 bg-purple-50 rounded-2xl">
            <BellRing className="text-purple-600" size={24} />
          </div>
          <div className="flex-1">
            <h2 className="text-lg md:text-2xl font-black text-gray-900 tracking-tight">Sales Notification Preferences</h2>
            <p className="text-sm md:text-base text-gray-400 mt-1 leading-relaxed">Choose which sales entry notifications you want to receive</p>
          </div>
        </div>
        ...
        {loadingPref ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="font-extrabold text-gray-800 text-sm md:text-base tracking-wide">Every Sale</span>
                </div>
                <span className="text-xs md:text-sm text-gray-400 mt-2 leading-relaxed">
              ...
              >
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="text-purple-600 focus:ring-purple-500 h-4 w-4"
                  />
                  <span className="font-extrabold text-gray-800 text-sm md:text-base tracking-wide">Specific Hotels</span>
                </div>
                <span className="text-xs md:text-sm text-gray-400 mt-2 leading-relaxed">
              ...
              >
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="text-purple-600 focus:ring-purple-500 h-4 w-4"
                  />
                  <span className="font-extrabold text-gray-800 text-sm md:text-base tracking-wide">Disabled</span>
                </div>
                <span className="text-xs md:text-sm text-gray-400 mt-2 leading-relaxed">
            ...
            {preferenceType === "specific" && (
              <div className="p-5 md:p-6 bg-slate-50/60 rounded-2xl space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="text-sm md:text-base font-extrabold text-gray-700 tracking-wide">Select Hotels:</div>
                {hotels.length === 0 ? (
                  <p className="text-xs md:text-sm text-gray-400 font-semibold">No hotels available.</p>
                ) : (
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {hotels.map((hotel) => {
                      ...
                      return (
                        <label
                          key={hotel.id}
                          className={`flex items-center gap-3 p-3.5 rounded-xl text-sm md:text-base cursor-pointer transition-all duration-200 ${isChecked
            ...
            <button
              ...
              disabled={savingPref}
              className={`w-full flex items-center justify-center gap-2 px-5 py-4 rounded-2xl text-white text-sm md:text-base font-extrabold tracking-wide transition-all active:scale-[0.98] ${savingPref
            ...
            {/* Success */}
            {prefSuccess && (
              <div className="flex items-center gap-3 p-4 bg-emerald-50 text-emerald-800 rounded-2xl text-sm md:text-base font-bold animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            {/* Error */}
            {prefError && (
              <div className="flex items-start gap-3 p-4 bg-rose-50 text-rose-800 rounded-2xl text-sm md:text-base font-bold animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-6 md:p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg md:text-2xl font-black text-gray-900 tracking-tight">Sales Reminder</h2>
            <p className="text-sm md:text-base text-gray-400 mt-1 leading-relaxed">Broadcast quick push notifications to all users</p>
          </div>
        </div>
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 px-5 py-4 rounded-2xl text-white text-sm md:text-base font-extrabold tracking-wide transition-all active:scale-[0.98] ${loadingReminder
        ...
        {reminderResponse && (
          <div className="p-5 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="flex items-center gap-2 text-emerald-800 font-extrabold text-sm md:text-base">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-sm">
                <div className="flex items-center gap-2 text-blue-600 mb-1">
                  <Users size={16} />
                  <span className="text-xs md:text-sm font-bold uppercase tracking-wider">Users</span>
                </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-sm">
                <div className="flex items-center gap-2 text-purple-600 mb-1">
                  <ShieldCheck size={16} />
                  <span className="text-xs md:text-sm font-bold uppercase tracking-wider">Admins</span>
                </div>
                <div className="text-2xl md:text-3xl font-black text-gray-900">
      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-6 md:p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg md:text-2xl font-black text-gray-900 tracking-tight">Custom Message</h2>
            <p className="text-sm md:text-base text-gray-400 mt-1 leading-relaxed">Create and send custom push notifications</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {/* Title */}
          <div>
            <label className="block text-xs md:text-sm font-extrabold text-gray-500 uppercase tracking-widest mb-2">
              Notification Title
            </label>
            <input
              type="text"
              ...
              className="w-full bg-slate-50 hover:bg-slate-100/60 focus:bg-white rounded-2xl px-4.5 py-3.5 md:px-5 md:py-4 text-sm md:text-base focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all text-slate-800 font-medium"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-50 hover:bg-slate-100/60 focus:bg-white rounded-2xl px-4.5 py-3.5 md:px-5 md:py-4 text-sm md:text-base focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all resize-none text-slate-800 font-medium leading-relaxed"
            />
            <div className="mt-3 p-3 bg-amber-50/70 rounded-2xl">
              <p className="text-xs md:text-sm text-amber-800 flex items-center gap-1.5 font-medium leading-relaxed">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-slate-50 hover:bg-slate-100/60 focus:bg-white rounded-2xl px-4 py-3.5 md:px-5 md:py-4 text-sm md:text-base focus:ring-2 focus:ring-orange-500 focus:outline-none transition-all appearance-none text-slate-800 font-bold"
                >
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl text-white text-sm md:text-base font-extrabold tracking-wide flex justify-center items-center gap-2 transition-all active:scale-[0.98] ${loadingCustom
